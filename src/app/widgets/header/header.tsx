...
function Header() {
  return (
    <header className="font-caption  sticky top-[0] z-[99] box-border flex max-w-full flex-row items-end justify-center  self-stretch overflow-hidden bg-white pb-[19px] pl-[42px] pr-5 pt-[17px] text-left text-base text-gray-900 shadow-[0px_1px_2px_rgba(0,_0,_0,_0.08)] lg:box-border lg:gap-[433.5px_217px] lg:pl-[21px]">
      ...
      <div className="hidden max-w-full flex-row items-start justify-start gap-[24px] lg:flex">
        <Link href={"/"} className="flex flex-row items-start justify-start px-5 py-2.5">
          <div className="relative inline-block min-w-[46px] font-medium leading-[150%]">Home</div>
        </Link>
